...
Following https://docs.traefik.io/v2.0/getting-started/quick-start/
...
.. literalinclude:: /src/compose-1/docker-compose-v1.yml
   :language: yaml
   :linenos:
...
.. literalinclude:: /src/compose-1/docker-compose.yml
   :language: yaml
   :linenos:
